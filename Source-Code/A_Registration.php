...
$ins_query="insert into a_register (`fname`,`mname`,`lname`,`pnumber`,`password`,`org`,`address`,`email`) values ('$fname','$mname','$lname','$pnumber','$password','$org','$address','$email')";
...
<head>
    ...
    <body>
        <ul class="topnav">
          ...
          <li><a  class="active" href="A_Registration.php">Admin Registration</a></li>
